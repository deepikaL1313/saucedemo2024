...
private Logger log = LogManager.getLogger(this.getClass().getName());
    ...
    public void verifyLoginWithValidCredentialsTest(String username, String password) throws Exception {
        ...
        try {
            ...
            takeScreenshot();
            s_assert.assertTrue(result, "PLP Page is not dispalyed");
        ...
        {
            s_assert.fail("Exception Occured during execution of Test : ["+e.getLocalizedMessage()+"]");
            log.error("Exception Occured during execution of Test ["+e.getMessage()+"]");
        }
        finally {
            takeScreenshot();
            s_assert.assertAll();
